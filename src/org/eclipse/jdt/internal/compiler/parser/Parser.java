...
protected void consumeRule(int act) {
  ...
  consumeMethodDeclaration(false);  
    ...
    case 705 : if (DEBUG) { System.out.println("BlockStatement ::= OhlEnumCaseDeclaration"); }  //$NON-NLS-1$
        consumeInvalidOhlEnumCaseDeclaration();  
      break;
 
     case 706 : if (DEBUG) { System.out.println("OhlEnumCaseDeclaration ::= OhlEnumCaseHeader..."); }  //$NON-NLS-1$
        consumeOhlEnumCaseDeclaration();  
      break;
 
     case 707 : if (DEBUG) { System.out.println("OhlEnumCaseHeader ::= OhlEnumCaseHeaderName..."); }  //$NON-NLS-1$
