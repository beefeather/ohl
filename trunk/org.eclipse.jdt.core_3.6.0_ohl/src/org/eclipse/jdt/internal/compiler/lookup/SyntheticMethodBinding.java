...
public class SyntheticMethodBinding extends MethodBinding {
    ...
    public final static int OhlReturn0 = 12; // switch table method   
    public final static int OhlVisitThis = 13; // switch table method
    public final static int OhlReturnThis = 14; // switch table method
	...
	*/
	...
	public SyntheticMethodBinding(MethodBinding overridenMethodToBridge, MethodBinding targetMethod, SourceTypeBinding declaringClass) {
	   ...
	   /**                                                                                                                                                                                                                                                                                      
	    * Construct an OHL visit this method                                                                                                                                                                                                                                                   
	    */                                                                                                                                                                                                                                                                                      
	   public SyntheticMethodBinding(MethodBinding overridenMethodToBridge, int returnValueFakeParam, SourceTypeBinding declaringClass, MethodBinding visitMethod) {                                                                                                                            
	     ...
	     this.tagBits |= (TagBits.AnnotationResolved | TagBits.DeprecatedAnnotationResolved);                                                                                                                                                                                                   
	       ...
	       this.purpose = SyntheticMethodBinding.OhlVisitThis;                                                                                                                                                                                                                                 
	     SyntheticMethodBinding[] knownAccessMethods = declaringClass.syntheticMethods();                                                                                                                                                                                                       
	     int methodId = knownAccessMethods == null ? 0 : knownAccessMethods.length;                                                                                                                                                                                                             
	     this.index = methodId;                                                                                                                                                                                                                                                                 
	   }                                                                                                                                                                                                                                                                                        
	   ...
	   interface ReturnThisMethodParam {
	  	 
	   }
	   /**                                                                                                                                                                                                                                                                                      
	    * Construct an OHL return this method                                                                                                                                                                                                                                                   
	    */                                                                                                                                                                                                                                                                                      
	   public SyntheticMethodBinding(MethodBinding overridenMethodToBridge, ReturnThisMethodParam fakeParam, SourceTypeBinding declaringClass) {                                                                                                                            
	       this.declaringClass = declaringClass;                                                                                                                                                                                                                                                
	       this.selector = overridenMethodToBridge.selector;                                                                                                                                                                                                                                    
	       // amongst other, clear the AccGenericSignature, so as to ensure no remains of original inherited persist (101794)                                                                                                                                                                   
	       // also use the modifiers from the target method, as opposed to inherited one (147690)                                                                                                                                                                                               
